 ...
 * File: admin/api/bridge/v1/dashboard/inquiries.php
...
if (!in_array('dashboard.inquiries', $auth['scopes'], true)) {
    http_response_code(403);
    echo json_encode(['ok' => false, 'error' => 'scope_forbidden'], JSON_UNESCAPED_UNICODE);
    exit;
}

echo json_encode(cm_bridge_dashboard_inquiries(), JSON_UNESCAPED_UNICODE);
