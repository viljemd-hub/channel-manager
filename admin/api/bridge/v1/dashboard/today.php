 ...
 * File: admin/api/bridge/v1/dashboard/today.php
...
if (!in_array('dashboard.today', $auth['scopes'], true)) {
    http_response_code(403);
    echo json_encode(['ok' => false, 'error' => 'scope_forbidden'], JSON_UNESCAPED_UNICODE);
    exit;
}

echo json_encode(cm_bridge_dashboard_today(), JSON_UNESCAPED_UNICODE);
